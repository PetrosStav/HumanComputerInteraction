...
public abstract class Initializer {
    ...
    public void prepareData() {
        ...
        p1.setName("Default Program 1");
        p1.setDescription("Default Program 1 Description");
        ...
        p2.setName("Default Program 2");
        p2.setDescription("Default Program 2 Description");
        ...
        p3.setName("Default Program 3");
        p3.setDescription("Default Program 3 Description");
        ...
        p4.setName("Default Program 4");
        p4.setDescription("Default Program 4 Description");
        ...
        p5.setName("Default Program 5");
        p5.setDescription("Default Program 5 Description");
